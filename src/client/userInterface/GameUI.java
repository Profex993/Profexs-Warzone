...
public class GameUI {
    ...
    private void drawLeaderBoard(Graphics2D g2) {
        ...
        g2.drawLine(GamePanel.screenWidth / 2 + 100, 0, GamePanel.screenWidth / 2 + 100, leaderBoard.size() * 40 + 40);
        g2.drawLine(GamePanel.screenWidth / 2 + 300, 0, GamePanel.screenWidth / 2 + 300, leaderBoard.size() * 40 + 40);
        g2.drawString("Name:", GamePanel.screenWidth / 2 - 300 + 10, 25);
        g2.drawString("Kills:", GamePanel.screenWidth / 2 - 100 + 10, 25);
        g2.drawString("Deaths:", GamePanel.screenWidth / 2 + 100 + 10, 25);
        for (int i = 0; i < leaderBoard.size(); i++) {
            g2.drawRect(GamePanel.screenWidth / 2 - 300, i * 40 + 40, 600, 40);
            g2.drawString(leaderBoard.get(i).getName(), GamePanel.screenWidth / 2 - 300 + 10, i * 40 + 65);
            g2.drawString(String.valueOf(leaderBoard.get(i).getKills()), GamePanel.screenWidth / 2 - 100 + 10, i * 40 + 65);
            g2.drawString(String.valueOf(leaderBoard.get(i).getDeaths()), GamePanel.screenWidth / 2 + 100 + 10, i * 40 + 65);
        }
    }
