...
public record Packet_PlayerUpdateInput(String id, int x, int y, String directionFace, boolean walking, double rotation,
    ...
    public static Packet_PlayerUpdateInput getFromPlayerData(PlayerServerSide player) {
        return new Packet_PlayerUpdateInput(player.getId(), player.getWorldX(), player.getWorldY(), player.getDirectionFace(),
    ...
    public String toString() {
        ...
        return head + ConstantsShared.protocolLineSplit + id + split + x + split + y + split + directionFace + split + walking + split + rotation + split +
