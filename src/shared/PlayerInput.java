...
public record PlayerInput(String id, int x, int y, String direction, String directionFace, boolean walking,
    ...
    public static PlayerInput parseFromString(String line) throws IOException {
        try {
            ...
            return new PlayerInput(parts[0], Integer.parseInt(parts[1]), Integer.parseInt(parts[2]), parts[3], parts[4],
                    Boolean.parseBoolean(parts[5]), Double.parseDouble(parts[6]), Double.parseDouble(parts[7]), Boolean.parseBoolean(parts[8]),
    ...
    public String getString() {
        ...
        return id + split + x + split + y + split + direction + split + directionFace + split + walking + split + mouseX + split + mouseY
